    ...
    return (
      <div className='activityLogWindow'>
        ...
        <div className='logResults'>
          <OX_Grid osjsCore={this.core} filterable={this.filterable} data={this.api} reorderable={this.reorderable} expandable={true} rowTemplate={(e) => this.renderRow(e)} resizable={this.resizable} pageable={this.pageable} sortable={this.sortable} columnConfig={this.state.columnConfig} />
        </div>
      </div>
    );
  }
