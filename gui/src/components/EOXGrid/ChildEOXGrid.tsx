 ...
 * @returns <EOXGrid/>
 */
class ChildEOXGrid extends React.Component<any, any> {
  ...
  constructor(props) {
    ...
    this.api = this.instance.replaceParams(
      this.instance.config.subRoute,
      this.event
    );
    this.state = {
