			...
			>
				...
				>
					...
					<SideNav.Nav defaultSelected={this.state.displaySection}>
						...
						this.userProfile.privileges.MANAGE_ACCOUNT_READ ? (
						...
						this.userProfile.privileges.MANAGE_USER_READ ? (
						...
						this.userProfile.privileges.MANAGE_ROLE_READ ? (
						...
						this.userProfile.privileges.MANAGE_TEAM_READ ? (
              ...
              ""
						...
						this.userProfile.privileges.MANAGE_USER_WRITE ? (
							<NavItem
								...
								key="EOXLogs"
								title="EOXLogs"
								onClick={() => this.externalLink("http://13.58.246.62:3000/")}
							>
								<NavIcon>
