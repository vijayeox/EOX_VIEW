        ...
        <SideNav onSelect={this.onSelect} style={({ overflowY: "scroll" }, { overflowX: "hidden" })}>
          ...
          <SideNav.Nav defaultSelected={this.state.displaySection}>
            ...
            {this.userProfile.privileges.MANAGE_APPBUILDER_READ || this.userProfile.privileges.MANAGE_APPBUILDER_WRITE ? (
              <NavItem eventKey={this.userProfile.privileges.MANAGE_APPBUILDER_READ} key={this.userProfile.privileges.MANAGE_APPBUILDER_READ} onClick={() => this.launchExternalApp("EOXAppBuilder")} title='App Builder' key='AppBuilder'>
                <NavIcon>
