...
// import { faUserAlt, faEye, } from "@fortawesome/fontawesome-solid";
...
const onDragEnd = (result, setRefresh, setReload) => {
  ...
  axios.put('https://qa3.eoxvantage.com:9080/app/454a1ec4-eeab-4dc2-8a3f-6a4255ffaee1/file/crud/' + draggableId,
...
export default function Board(props) {
  ...
  useEffect(() => {
    axios.get('https://qa3.eoxvantage.com:9080/app/454a1ec4-eeab-4dc2-8a3f-6a4255ffaee1/field/b0fd5ad1-607b-11eb-a441-06a328860aa2', {
      headers: {
        authorization: authorizationValue
      }
    }).then((res) => {
      ...
      // console.log(tempField.values.length)
      setFieldset([])
  ...
  const dateRangeHandler = (mindatevalue, maxdatevalue) => {
    ...
    setFilter([{ "field": "start_date", "operator": "gte", "value": mindatevalue },
  ...
  return (
    <div>
      <div className="expense-item"><div>
        ...
        <Button variant="link" style={{ color: 'black' }}>
          ...
          <Badge>
            <select
              ...
              style={{ fontSize: 'small', borderColor: 'transparent', outlineColor: 'transparent', background: 'transparent' }}
              name="priority"
              onChange={e => {
        ...
        <Button variant="link" style={{ color: 'black', fontWeight: 400 }}>
          ...
          <Badge>
            <select
              className="form-control"
              style={{ fontSize: 'small', borderColor: 'transparent', background: 'transparent', outlineColor: 'transparent' }}
              name="priority">
      ...
      <br />
      <DragDropContext onDragEnd={result => onDragEnd(result, setRefresh, setReload)}>
        <ListGroup horizontal className="lanes_list">
          {fieldset.map((dataItem, index) => {
            console.log(filterMaker(dataItem))
            return (
              <Work
                info={dataItem}
                filter={filterMaker(dataItem.value)}
